...
import { Employee, demoEmployees, DEPARTMENTS, formatDate } from './hrTypes';
            ...
            <tbody>
              {filteredEmployees.map(emp => (
                <tr key={emp.id}>
                  ...
                  <td>{emp.position}</td>
                  <td>
                    <span className={`hr-badge ${emp.status}`}>{emp.status}</span>
                  </td>
            ...
            <div className="modal-content border-0 shadow" style={{ borderRadius: '16px' }}>
              ...
              <form onSubmit={handleAdd}>
                ...
                <div className="modal-footer border-0">
                  ...
                  <button type="submit" className="btn text-white fw-bold px-4" style={{ backgroundColor: '#10b981' }}>Add Employee</button>
                </div>
              </form>
            </div>
          </div>
